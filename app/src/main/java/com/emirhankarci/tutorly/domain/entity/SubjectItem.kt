...
val subjects = listOf(
    ...
    SubjectInfo(R.drawable.subject_book, "Biyoloji", "2 Konu", Color(0xFF4CAF50), Color(0xFF4CAF50)),
    SubjectInfo(R.drawable.subject_book, "Coğrafya", "7 Konu", Color(0xFFFFC107), Color(0xFFFFC107)),
