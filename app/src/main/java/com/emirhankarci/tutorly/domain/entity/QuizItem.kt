...
fun getQuizQuestions(subject: String, chapter: String, questionType: QuestionType, count: Int): List<QuizQuestion> {
    val allQuestions = when (subject) {
        ...
        "Türk Dili ve Edebiyati" -> getTurkishQuizQuestions(chapter, questionType)
...
private fun getTurkishQuizQuestions(chapter: String, type: QuestionType) = getDefaultQuizQuestions("Türk Dili ve Edebiyati", chapter, type)
